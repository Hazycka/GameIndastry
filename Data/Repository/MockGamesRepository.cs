...
namespace GameIndastry_v2.Data.Repository
{
    public class MockGamesRepository : IRepository
    {
        ...
        {
            GameModel tempGame = _games.FirstOrDefault(x => x.Id.Equals(id));
            ...
            return new GameModel()
            {
                ...
                Image = tempGame.Image,
                ReleaseDate = tempGame.ReleaseDate,
                Genres = tempGame.Genres,
                InSale = tempGame.InSale
            };
        }
            ...
            for (int i = 0; i <= randomGenrecount; i++)
            {
                ...
                if (result is not null)
                {
                    genresForReturning.Add(
                        new GamesGenres { GameId = gameId, GenreId = genreId });
                }
            }
